...
import com.jxau.train.batch.req.CronJobReq;
import com.jxau.train.batch.resp.CronJobResp;
...
public class JobController {
    ...
    public CommonResp add(@RequestBody CronJobReq cronJobReq) {
        String jobClassName = cronJobReq.getName();//全限定类名
        String jobGroupName = cronJobReq.getGroup();//组
        String cronExpression = cronJobReq.getCronExpression();//cron 表达式
